...
\ustcsetup{
  title              = {面向情感对话与语音交互的\\大模型情绪分析系统},
  title*             = {Large Model-Based Emotion Analysis System for Sentiment Dialogue and Voice Interaction},
  author             = {邹鹏},
  author*            = {Zou Peng},
  speciality         = {计算机技术},
  speciality*        = {Computer Technology},
  supervisor         = {周文罡 教授, 陈欣},
  supervisor*        = {Prof. Zhou WenGang, Chen Xin},

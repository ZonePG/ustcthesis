...
\ustcsetup{
  title              = {面向情感对话与语音交互的大模型\\情绪分析方法研究及系统实现},
  title*             = {Large Model-Based Emotion Analysis System for Sentiment Dialogue and Speech Interaction},
  author             = {邹鹏},
  author*            = {Zou Peng},
  speciality         = {计算机技术},
  speciality*        = {Computer Technology},
  supervisor         = {周文罡教授},
  practice-supervisor = {陈欣研究员},
  supervisor*        = {Prof. Zhou Wengang},
  practice-supervisor* = {Researcher. Chen Xin},
